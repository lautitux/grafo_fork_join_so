...
{
	if (region.a$.J === region.aN.J)
	{
		return 'on line ' + region.a$.J;
	}
	return 'on lines ' + region.a$.J + ' through ' + region.aN.J;
}
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{O: '', C: $elm$core$Maybe$Nothing, H: $elm$core$Maybe$Nothing, E: $elm$core$Maybe$Nothing},
...
var $author$project$Compiler$advance = function (state) {
	return _Utils_update(
		state,
		{
			t: A2($elm$core$List$drop, 1, state.t),
			p: state.p + 1
		});
};
...
var $author$project$Parse$Located = F3(
	function (start, value, end) {
		return {aN: end, a$: start, aB: value};
	});
var $author$project$Compiler$located = F2(
	function (loc, val) {
		return A3($author$project$Parse$Located, loc.a$, val, loc.aN);
	});
			...
			if (!_v0.b) {
				...
				switch (_v1.$) {
					...
					case 1:
						var ident = _v1.a;
						var value = _v1.b;
						if (A2($elm$core$Dict$member, ident, state.s)) {
							return $elm$core$Result$Err(
							...
							var $temp$parents = parents,
								...
								_Utils_update(
									state,
									{
										s: A3($elm$core$Dict$insert, ident, value, state.s)
									}));
							parents = $temp$parents;
							state = $temp$state;
							continue compileStatements;
					...
					case 4:
						var ident = _v1.a;
						var lbl = _v1.b;
						var _v3 = A2($elm$core$Dict$get, ident, state.s);
						if (_v3.$ === 1) {
							return $elm$core$Result$Err(
							...
							var new_state = $author$project$Compiler$advance(
								_Utils_update(
									state,
									{
										s: A3($elm$core$Dict$insert, ident, value - 1, state.s)
									}));
							var join_parents = function () {
								var _v4 = A2($elm$core$Dict$get, state.p, state.I);
								if (_v4.$ === 1) {
									return parents;
								} else {
									var others = _v4.a;
							...
							if (value === 1) {
								...
								var $temp$parents = parents,
									...
									new_state,
									{
										I: A3($elm$core$Dict$insert, state.p, join_parents, state.I)
									});
								parents = $temp$parents;
								state = $temp$state;
								continue compileStatements;
...
var $author$project$Compiler$compile = function (stmts) {
	var state = {s: $elm$core$Dict$empty, t: stmts, H: $elm$core$Dict$empty, p: 0, I: $elm$core$Dict$empty, T: stmts};
	return A2(
		$elm$core$Result$map,
		function (s) {
			return s.H;
...
var $author$project$Util$deadEndToLocatedString = function (deadEnd) {
	return {
		aN: _Utils_Tuple2(deadEnd.au, deadEnd.Y),
		a$: _Utils_Tuple2(deadEnd.au, deadEnd.Y),
		aB: function () {
			var _v0 = deadEnd.aY;
			switch (_v0.$) {
				case 0:
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {Y: col, aY: problem, au: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.au, p.Y, p.aY);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{Y: 1, c: _List_Nil, d: 1, b: 0, au: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {Y: col, aK: contextStack, aY: problem, au: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.au, s.Y, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.b, s.au, s.Y, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			...
			0,
			{Y: newCol, c: s.c, d: s.d, b: adjustedOffset, au: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.au, s.Y, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{Y: newCol, c: s.c, d: s.d, b: newOffset, au: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{Y: col, c: s0.c, d: s0.d, b: offset, au: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.au, s.Y, s);
	};
};
var $elm$parser$Parser$chompWhile = $elm$parser$Parser$Advanced$chompWhile;
var $author$project$Parse$spacesOrNewLine = $elm$parser$Parser$chompWhile(
	function (c) {
		return (c === ' ') || ((c === '\t') || ((c === '\u000D') || (c === '\n')));
	});
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {Y: col, c: context, d: indent, b: offset, au: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.a$, s.b, s.a);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.aS, s.b + 1, s.au + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.aS, firstOffset, s.au, s.Y + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aa: $elm$parser$Parser$ExpectingVariable, aS: i.aS, aZ: i.aZ, a$: i.a$});
};
var $author$project$Parse$identifier = $elm$parser$Parser$variable(
	{
		aS: function (c) {
...
var $author$project$Parse$label = A2(
...
var $author$project$Parse$located = function (parser) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$keeper,
				$elm$parser$Parser$succeed($author$project$Parse$Located),
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.au, s.Y, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $author$project$Parse$fork = A2($author$project$Parse$unary, 'FORK', $author$project$Parse$Fork);
var $author$project$Parse$Goto = function (a) {
	return {$: 3, a: a};
};
var $author$project$Parse$goto = A2($author$project$Parse$unary, 'GOTO', $author$project$Parse$Goto);
var $author$project$Parse$Join = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Parse$binary = F2(
	function (s, map) {
		return A2(
			$elm$parser$Parser$keeper,
			A2(
...
var $author$project$Parse$join = A2($author$project$Parse$binary, 'JOIN', $author$project$Parse$Join);
var $author$project$Parse$Quit = {$: 5};
var $author$project$Parse$quit = A2(
	$elm$parser$Parser$ignorer,
	$elm$parser$Parser$succeed($author$project$Parse$Quit),
	$elm$parser$Parser$keyword('QUIT'));
var $author$project$Parse$application = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$author$project$Parse$quit, $author$project$Parse$fork, $author$project$Parse$goto, $author$project$Parse$join]));
var $author$project$Parse$Counter = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {Y: s.Y + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, au: s.au, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.au, s.Y - (floatOffset + s.b), invalid, s.c));
		} else {
...
var $author$project$Parse$counter = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($author$project$Parse$Counter),
		A2(
			$elm$parser$Parser$ignorer,
			A2(
				$elm$parser$Parser$ignorer,
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$backtrackable($author$project$Parse$identifier),
					$elm$parser$Parser$backtrackable($author$project$Parse$spaces)),
				$elm$parser$Parser$symbol('=')),
			$author$project$Parse$spaces)),
	$elm$parser$Parser$int);
var $author$project$Parse$Process = function (a) {
	return {$: 6, a: a};
};
var $author$project$Parse$process = A2(
	$elm$parser$Parser$keeper,
	$elm$parser$Parser$succeed($author$project$Parse$Process),
	$author$project$Parse$identifier);
var $author$project$Parse$unlabeled_statement = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$author$project$Parse$counter, $author$project$Parse$application, $author$project$Parse$process]));
var $author$project$Parse$labeled_statement = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
			F2(
				function (lbl, stmt) {
					return _Utils_Tuple2(lbl, stmt);
				})),
		$elm$parser$Parser$backtrackable(
			$author$project$Parse$located($author$project$Parse$label))),
		...
		_List_fromArray(
			[
				...
				$elm$parser$Parser$succeed(
					function (_v0) {
						var lbl = _v0.a;
						var maybe_stmt = _v0.b;
						if (!maybe_stmt.$) {
							var stmt = maybe_stmt.a;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _v1 = $author$project$Parse$parse(model.O);
				if (!_v1.$) {
					var stmts = _v1.a;
					var _v2 = A2(
						$elm$core$Result$map,
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$text(
																	'Error [' + ($elm$core$String$fromInt(err.a$.a) + (':' + ($elm$core$String$fromInt(err.a$.b) + ']'))))
																])),
															A2($elm$html$Html$br, _List_Nil, _List_Nil),
															$elm$html$Html$text(err.aB)
														]))
												]))
										]);
								} else {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://github.com/lautitux')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Lautaro Montes')
									])),
								$elm$html$Html$text(' in 2025')
							]))
					]))
			]));
};
